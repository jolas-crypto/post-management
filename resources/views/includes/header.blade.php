...
<nav class="bg-white">
    ...
    <ul class="post-nav border-b border-gray-200 flex item-center px-8 mt-4">
        <li class="font-semibold">
            <a href="{{ route('post.index') }}" class="nav-module items-center aes {{ request()->is('post') ? 'active-nav' : '' }}">
        ...
        <li class="font-semibold">
            <a href="{{ route('posted.index') }}" class="nav-module items-center aes {{ request()->is('posted') ? 'active-nav' : '' }}">
                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-4">
        ...
        <li class="font-semibold">
            <a href="{{ route('unarchive.index') }}" class="nav-module items-center aes {{ request()->is('unarchive') ? 'active-nav' : '' }}">
                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-4">
